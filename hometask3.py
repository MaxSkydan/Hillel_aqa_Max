...
"""Format"""
text_format = 'Automatisering akselererer {0}yeblikket da roboter vil erobre planeten v{1}r. ({2})'
logging.info(text_format.format('ø', 'å', 'Æ'))
# another format
new_text = 'Automatisering akselererer {0}yeblikket da roboter vil erobre planeten v{1}r. ({2})'.format('ø', 'å', 'Æ')
logging.info(new_text)

"""f-string"""
text_f_string = f"Automatisering akselererer {'ø'}yeblikket da roboter vil erobre planeten v{'å'}r. ({'Æ'})"
